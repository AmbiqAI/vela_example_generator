...
int p1_lin_12k_s1_pool_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       p1_lin_12k_s1_pool_cmd_data, (int)p1_lin_12k_s1_pool_cmd_size,
