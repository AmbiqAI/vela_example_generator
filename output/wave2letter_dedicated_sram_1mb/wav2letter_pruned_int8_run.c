...
int wav2letter_pruned_int8_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       wav2letter_pruned_int8_cmd_data, (int)wav2letter_pruned_int8_cmd_size,
