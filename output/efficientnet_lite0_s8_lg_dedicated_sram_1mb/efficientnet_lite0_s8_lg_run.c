...
int efficientnet_lite0_s8_lg_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       efficientnet_lite0_s8_lg_cmd_data, (int)efficientnet_lite0_s8_lg_cmd_size,
