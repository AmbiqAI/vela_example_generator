...
int mobilenet_v2_224_INT8_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       mobilenet_v2_224_INT8_cmd_data, (int)mobilenet_v2_224_INT8_cmd_size,
