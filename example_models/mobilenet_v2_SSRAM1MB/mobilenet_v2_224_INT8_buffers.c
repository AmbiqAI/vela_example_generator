...
#include <stddef.h>
#include <stdint.h>
#include "mobilenet_v2_224_INT8_weights.h"
...
uint8_t* get_region_base_ptr(int region) {
    switch(region) {
    case 1: return mobilenet_v2_224_INT8_region_1;
    case 2: return mobilenet_v2_224_INT8_region_2;
    case 0: return (uint8_t*)mobilenet_v2_224_INT8_weights; // weights region
...
size_t get_region_size(int region) {
    switch(region) {
    case 1: return sizeof(mobilenet_v2_224_INT8_region_1);
    case 2: return sizeof(mobilenet_v2_224_INT8_region_2);
    case 0: return mobilenet_v2_224_INT8_weights_size;
    default: return 0;
    }
}
