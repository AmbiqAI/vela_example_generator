...
#include "mobilenet_v3_sm_min_s8_md_AmbiqHP_HBLRAM_Dedicated_Sram_cmd_data.h"
...
#include "mobilenet_v3_sm_min_s8_md_AmbiqHP_HBLRAM_Dedicated_Sram_buffers.h"

// Provide your platform's NPU register base here.
extern void *ethosu_get_regs_base(void);

int mobilenet_v3_sm_min_s8_md_AmbiqHP_HBLRAM_Dedicated_Sram_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       mobilenet_v3_sm_min_s8_md_AmbiqHP_HBLRAM_Dedicated_Sram_cmd_data, (int)mobilenet_v3_sm_min_s8_md_AmbiqHP_HBLRAM_Dedicated_Sram_cmd_size,
