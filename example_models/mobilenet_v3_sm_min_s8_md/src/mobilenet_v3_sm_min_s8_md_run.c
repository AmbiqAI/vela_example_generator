...
int mobilenet_v3_sm_min_s8_md_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       mobilenet_v3_sm_min_s8_md_cmd_data, (int)mobilenet_v3_sm_min_s8_md_cmd_size,
