...
int conlarge_xl_AmbiqLP_PSRAM_Dedicated_Sram_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       conlarge_xl_AmbiqLP_PSRAM_Dedicated_Sram_cmd_data, (int)conlarge_xl_AmbiqLP_PSRAM_Dedicated_Sram_cmd_size,
