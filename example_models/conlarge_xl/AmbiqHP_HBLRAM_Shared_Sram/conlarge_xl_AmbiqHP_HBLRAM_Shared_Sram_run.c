...
int conlarge_xl_AmbiqHP_HBLRAM_Shared_Sram_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       conlarge_xl_AmbiqHP_HBLRAM_Shared_Sram_cmd_data, (int)conlarge_xl_AmbiqHP_HBLRAM_Shared_Sram_cmd_size,
