...
#include "conlarge_xl_AmbiqHP_HBLRAM_Shared_Sram_256KB_cmd_data.h"
...
#include "conlarge_xl_AmbiqHP_HBLRAM_Shared_Sram_256KB_buffers.h"

// Provide your platform's NPU register base here.
extern void *ethosu_get_regs_base(void);

int conlarge_xl_AmbiqHP_HBLRAM_Shared_Sram_256KB_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       conlarge_xl_AmbiqHP_HBLRAM_Shared_Sram_256KB_cmd_data, (int)conlarge_xl_AmbiqHP_HBLRAM_Shared_Sram_256KB_cmd_size,
