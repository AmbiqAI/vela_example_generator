...
int conlarge_xl_AmbiqHP_HBLRAM_Dedicated_Sram_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       conlarge_xl_AmbiqHP_HBLRAM_Dedicated_Sram_cmd_data, (int)conlarge_xl_AmbiqHP_HBLRAM_Dedicated_Sram_cmd_size,
