...
int conlarge_xl_AmbiqHP_PSRAM_Shared_Sram_256KB_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       conlarge_xl_AmbiqHP_PSRAM_Shared_Sram_256KB_cmd_data, (int)conlarge_xl_AmbiqHP_PSRAM_Shared_Sram_256KB_cmd_size,
