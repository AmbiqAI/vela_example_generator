...
int conlarge_xl_AmbiqLP_HBLRAM_Sram_Only_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       conlarge_xl_AmbiqLP_HBLRAM_Sram_Only_cmd_data, (int)conlarge_xl_AmbiqLP_HBLRAM_Sram_Only_cmd_size,
