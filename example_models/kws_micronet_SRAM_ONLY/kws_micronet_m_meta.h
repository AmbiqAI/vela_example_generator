...
#define KWS_MICRONET_M_INPUT0_OFFSET  70560
#define KWS_MICRONET_M_INPUT0_SIZE    490

// ---- Outputs ----
#define KWS_MICRONET_M_OUTPUT0_REGION 1
#define KWS_MICRONET_M_OUTPUT0_OFFSET 208
#define KWS_MICRONET_M_OUTPUT0_SIZE   12

// ---- Variables ----

#define KWS_MICRONET_M_SCRATCH_REGION 1
#define KWS_MICRONET_M_SCRATCH_SIZE   88560
#define KWS_MICRONET_M_SCRATCH_FAST_REGION 0
#define KWS_MICRONET_M_SCRATCH_FAST_SIZE   0
