...
int ic_AmbiqLP_SRAM_Sram_Only_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       ic_AmbiqLP_SRAM_Sram_Only_cmd_data, (int)ic_AmbiqLP_SRAM_Sram_Only_cmd_size,
