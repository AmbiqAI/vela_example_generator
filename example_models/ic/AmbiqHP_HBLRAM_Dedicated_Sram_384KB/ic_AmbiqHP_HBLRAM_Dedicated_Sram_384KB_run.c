...
int ic_AmbiqHP_HBLRAM_Dedicated_Sram_384KB_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       ic_AmbiqHP_HBLRAM_Dedicated_Sram_384KB_cmd_data, (int)ic_AmbiqHP_HBLRAM_Dedicated_Sram_384KB_cmd_size,
