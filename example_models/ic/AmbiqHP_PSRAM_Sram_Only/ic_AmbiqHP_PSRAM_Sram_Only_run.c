...
int ic_AmbiqHP_PSRAM_Sram_Only_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       ic_AmbiqHP_PSRAM_Sram_Only_cmd_data, (int)ic_AmbiqHP_PSRAM_Sram_Only_cmd_size,
