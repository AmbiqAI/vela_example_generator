...
int ic_AmbiqLP_PSRAM_Dedicated_Sram_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       ic_AmbiqLP_PSRAM_Dedicated_Sram_cmd_data, (int)ic_AmbiqLP_PSRAM_Dedicated_Sram_cmd_size,
