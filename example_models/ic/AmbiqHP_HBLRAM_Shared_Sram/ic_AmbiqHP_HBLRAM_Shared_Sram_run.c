...
int ic_AmbiqHP_HBLRAM_Shared_Sram_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       ic_AmbiqHP_HBLRAM_Shared_Sram_cmd_data, (int)ic_AmbiqHP_HBLRAM_Shared_Sram_cmd_size,
