...
int ic_AmbiqLP_PSRAM_Dedicated_Sram_512KB_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       ic_AmbiqLP_PSRAM_Dedicated_Sram_512KB_cmd_data, (int)ic_AmbiqLP_PSRAM_Dedicated_Sram_512KB_cmd_size,
