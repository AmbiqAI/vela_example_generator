...
int ic_AmbiqLP_HBLRAM_Shared_Sram_256KB_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       ic_AmbiqLP_HBLRAM_Shared_Sram_256KB_cmd_data, (int)ic_AmbiqLP_HBLRAM_Shared_Sram_256KB_cmd_size,
