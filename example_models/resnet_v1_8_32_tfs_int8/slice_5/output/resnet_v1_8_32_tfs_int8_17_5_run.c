...
int resnet_v1_8_32_tfs_int8_17_5_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       resnet_v1_8_32_tfs_int8_17_5_cmd_data, (int)resnet_v1_8_32_tfs_int8_17_5_cmd_size,
