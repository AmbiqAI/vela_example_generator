...
int resnet_v1_8_32_tfs_int8_17_6_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       resnet_v1_8_32_tfs_int8_17_6_cmd_data, (int)resnet_v1_8_32_tfs_int8_17_6_cmd_size,
