...
#include "efficientnet_lite0_s8_lg_AmbiqLP_HBLRAM_Shared_Sram_cmd_data.h"
...
#include "efficientnet_lite0_s8_lg_AmbiqLP_HBLRAM_Shared_Sram_buffers.h"

// Provide your platform's NPU register base here.
extern void *ethosu_get_regs_base(void);

int efficientnet_lite0_s8_lg_AmbiqLP_HBLRAM_Shared_Sram_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       efficientnet_lite0_s8_lg_AmbiqLP_HBLRAM_Shared_Sram_cmd_data, (int)efficientnet_lite0_s8_lg_AmbiqLP_HBLRAM_Shared_Sram_cmd_size,
