...
#include "efficientnet_lite0_s8_lg_AmbiqLP_PSRAM_Dedicated_Sram_256KB_cmd_data.h"
...
#include "efficientnet_lite0_s8_lg_AmbiqLP_PSRAM_Dedicated_Sram_256KB_buffers.h"

// Provide your platform's NPU register base here.
extern void *ethosu_get_regs_base(void);

int efficientnet_lite0_s8_lg_AmbiqLP_PSRAM_Dedicated_Sram_256KB_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       efficientnet_lite0_s8_lg_AmbiqLP_PSRAM_Dedicated_Sram_256KB_cmd_data, (int)efficientnet_lite0_s8_lg_AmbiqLP_PSRAM_Dedicated_Sram_256KB_cmd_size,
