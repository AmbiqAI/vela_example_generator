...
int fc_in__200__o_32_relu_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       fc_in__200__o_32_relu_cmd_data, (int)fc_in__200__o_32_relu_cmd_size,
