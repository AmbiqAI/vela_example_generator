...
#include "fc_in__200__o_32_relu_AmbiqHP_HBLRAM_Dedicated_Sram_cmd_data.h"
...
#include "fc_in__200__o_32_relu_AmbiqHP_HBLRAM_Dedicated_Sram_buffers.h"

// Provide your platform's NPU register base here.
extern void *ethosu_get_regs_base(void);

int fc_in__200__o_32_relu_AmbiqHP_HBLRAM_Dedicated_Sram_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       fc_in__200__o_32_relu_AmbiqHP_HBLRAM_Dedicated_Sram_cmd_data, (int)fc_in__200__o_32_relu_AmbiqHP_HBLRAM_Dedicated_Sram_cmd_size,
