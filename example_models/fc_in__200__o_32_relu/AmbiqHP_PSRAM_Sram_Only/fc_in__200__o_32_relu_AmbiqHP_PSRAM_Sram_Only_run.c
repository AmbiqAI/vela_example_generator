...
#include "fc_in__200__o_32_relu_AmbiqHP_PSRAM_Sram_Only_cmd_data.h"
...
#include "fc_in__200__o_32_relu_AmbiqHP_PSRAM_Sram_Only_buffers.h"

// Provide your platform's NPU register base here.
extern void *ethosu_get_regs_base(void);

int fc_in__200__o_32_relu_AmbiqHP_PSRAM_Sram_Only_invoke(void) {
    ...
    rc = ethosu_invoke(&drv,
                       fc_in__200__o_32_relu_AmbiqHP_PSRAM_Sram_Only_cmd_data, (int)fc_in__200__o_32_relu_AmbiqHP_PSRAM_Sram_Only_cmd_size,
